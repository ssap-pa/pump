...
export type NotesProps = { draftOwner:string|null; onBlockNavigation:(blocked:boolean)=>void; site:Rec; rows:Rec[]; busy:boolean; onSave:(data:NoteData)=>Promise<boolean>; onRefresh:()=>Promise<boolean> };
